...
export interface ComptrollerInterface extends utils.Interface {
  functions: {
    ...
    "_changeAdmin(address)": FunctionFragment;
    "_grantComp(address,uint256)": FunctionFragment;
    "_initializeNftCollateral(address,address,uint256)": FunctionFragment;
    ...
    "_setNftCollateralFactor(uint256)": FunctionFragment;
    "_setNftPriceOracle(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "_initializeNftCollateral",
  ...
  encodeFunctionData(
    functionFragment: "_setNftCollateralFactor",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "_setNftPriceOracle",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "NewNftCollateralFactor(uint256,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "NewNftCollateralFactor"): EventFragment;
...
export type NewNftCollateralFactorEvent = TypedEvent<
  [BigNumber, BigNumber],
  {
    oldCollateralFactorMantissa: BigNumber;
    newCollateralFactorMantissa: BigNumber;
...
export type NewNftCollateralFactorEventFilter =
  TypedEventFilter<NewNftCollateralFactorEvent>;
...
export interface Comptroller extends BaseContract {
  ...
  callStatic: {
    ...
    _changeAdmin(newAdmin: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "NewNftCollateralFactor(uint256,uint256)"(
      oldCollateralFactorMantissa?: null,
      newCollateralFactorMantissa?: null
    ): NewNftCollateralFactorEventFilter;
    NewNftCollateralFactor(
      oldCollateralFactorMantissa?: null,
      newCollateralFactorMantissa?: null
    ): NewNftCollateralFactorEventFilter;
