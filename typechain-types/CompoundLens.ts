...
export interface CompoundLens extends BaseContract {
  ...
  functions: {
    ...
    ): Promise<[CompBalanceMetadataStructOutput]>;
    ...
    getCompVotes(
      ...
      overrides?: CallOverrides
    ): Promise<[CompVotesStructOutput[]]>;

    getGovBravoProposals(
      governor: string,
      proposalIds: BigNumberish[],
      overrides?: CallOverrides
    ): Promise<[GovBravoProposalStructOutput[]]>;
    ...
    getGovBravoReceipts(
      ...
      proposalIds: BigNumberish[],
      overrides?: CallOverrides
    ): Promise<[GovBravoReceiptStructOutput[]]>;

    getGovProposals(
      governor: string,
      proposalIds: BigNumberish[],
      overrides?: CallOverrides
    ): Promise<[GovProposalStructOutput[]]>;
    ...
    getGovReceipts(
      ...
      proposalIds: BigNumberish[],
      overrides?: CallOverrides
    ): Promise<[GovReceiptStructOutput[]]>;
  };
  ...
  callStatic: {
    cTokenBalances(
      ...
      account: string,
      overrides?: CallOverrides
    ): Promise<CTokenBalancesStructOutput>;
    ...
    cTokenMetadata(
      cToken: string,
      overrides?: CallOverrides
    ): Promise<CTokenMetadataStructOutput>;
    ...
    cTokenUnderlyingPrice(
      cToken: string,
      overrides?: CallOverrides
    ): Promise<CTokenUnderlyingPriceStructOutput>;
    ...
    getAccountLimits(
      ...
      account: string,
      overrides?: CallOverrides
    ): Promise<AccountLimitsStructOutput>;
    ...
    getCompBalanceMetadataExt(
      ...
      account: string,
      overrides?: CallOverrides
    ): Promise<CompBalanceMetadataExtStructOutput>;
