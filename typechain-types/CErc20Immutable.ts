...
export interface CErc20ImmutableInterface extends utils.Interface {
  functions: {
    ...
    "liquidateBorrowNft(address,uint256,address,uint256[],uint256[])": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "liquidateBorrowNft",
...
export interface CErc20Immutable extends BaseContract {
