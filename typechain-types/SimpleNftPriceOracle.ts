...
export interface SimpleNftPriceOracleInterface extends utils.Interface {
  functions: {
...
export interface SimpleNftPriceOracle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SimpleNftPriceOracleInterface;
