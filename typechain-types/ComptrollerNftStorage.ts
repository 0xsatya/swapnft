...
export interface ComptrollerNftStorageInterface extends utils.Interface {
  functions: {
...
export interface ComptrollerNftStorage extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ComptrollerNftStorageInterface;
